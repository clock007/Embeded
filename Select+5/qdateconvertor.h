...
{
  Q_OBJECT
  Q_PROPERTY(QString ERR_YEAR READ E_YEAR NOTIFY YearChanged)
  Q_PROPERTY(QString ERR_MONTH READ E_MONTH NOTIFY MonthChanged)
  Q_PROPERTY(QString ERR_DAY READ E_DAY NOTIFY DayChanged)
  Q_PROPERTY(QString ERR_DAYWEEK READ E_DAYWEEK NOTIFY DayWeekChanged)
private:
    int div(int,int);
    void set_months();
    void set_days();
...
public:
    QDateConvertor(QObject *parent=nullptr);
    ...
    Q_INVOKABLE void Shamsi();
    Q_INVOKABLE void Shamsi2();
